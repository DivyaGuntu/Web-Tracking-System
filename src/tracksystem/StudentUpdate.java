...
{ 
	...
	System.out.println("u are at studentUpdate.java  and user student id is " + studentid);
	
	 if (request.getParameter("update") != null) {
	
	 String id = request.getParameter("id");
	 String id2 = studentid;
 ...
 /*   InputStream inputStream = null; // input stream of the upload file
    ...
    String message = null;
    System.out.println("connected successful at studentupdate.java with fn: " + fn + "  " + ln +" " + un+ " " + dob1 +" " + mail + " "+ mj +" "+quest +" "+ answ);
	
   try{
		       Class.forName("com.mysql.jdbc.Driver");
		       conn = DriverManager.getConnection(db_url,db_username,db_password);
		       // constructs SQL statement
		       String sql = "update  student set firstname=?, lastname=? , dateofbirth=?, email=?, major=?, securityquestion=?, securityanswer=?, graduatedate=? where studentid=?";
		...
		//       statement.setDate(9, gd);
		      ...
		      // statement.setString(15, "false");
		       ...
		       System.out.println("prepared statment successful at studentupdate.java" + email2);
		 ...
		 //      System.out.println(email2);
		       ...
		       if (row > 0)
		       {
		    	   System.out.println("student table is updated");
		       }
		       if (row2 > 0)
		       {
		       ...
		       if (row > 0 && row2 > 0) {
			            System.out.println("rows updated at studentupdate.java");
			
			        	message = "student update successful";           
			       
				      String sql3 = "select * from student where studentid = '"+studentid+"'";
